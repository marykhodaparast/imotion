                                    ...
                                    @for ($j = 1; $j <= 20; $j++)
                                        ...
                                        <td class="{{ (jdate()->format('w') + $i) % 7 ? 'cursor_pointer hoverable':''}}"
                                            ...
                                            <div class="row justify-content-center">
                                                @if(!substr($user_slot,-1) || (substr($user_slot,-1) == 1 && $user_slot != $j) || (substr($user_slot,-1) == 2 && $user_slot != $j) || (substr($user_slot,-1) == 3 && $user_slot != $j) )
                                                   @for($k = 0;$k < 3; $k++)
                                                    <i class="far fa-user"></i>
                                                   @endfor
                                                @elseif(substr($user_slot,-1) == 1 && $user_slot == $j)
                                                   <i class="fas fa-user accepted"></i>
                                                   <i class="far fa-user"></i>
                                                   <i class="far fa-user"></i>
                                                @elseif(substr($user_slot,-1) == 2 && $user_slot == $j)
                                                   <i class="fas fa-user accepted"></i>
                                                   <i class="fas fa-user accepted"></i>
                                                   <i class="far fa-user"></i>
                                                @elseif(substr($user_slot,-1) == 3 && $user_slot == $j )
                                                   @for($k = 0;$k < 3; $k++)
                                                     <i class="fas fa-user accepted"></i>
                                                   @endfor
                                                @endif
